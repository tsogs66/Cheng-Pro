  ...
  async render(root) {
    ...
    root.innerHTML = `
      <section class="panel hero">
        <h1>Cheng-Pro</h1>
        <p>All-in-one suite for marine chief engineers. One active vessel feeds full Voyage Chief and Tank Chief side by side. Ship details are shared; voyage and tank records stay in their own stores.</p>
      </section>
      <section class="panel">
        ...
        <div class="chips" style="margin-top:14px">
          <span class="chip ${health.ok ? 'on' : ''}">Gateway ${health.ok ? 'online' : 'offline'}</span>
