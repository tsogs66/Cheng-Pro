...
const DATA_DIR = env.CHENG_PRO_DATA_DIR || env.TMS_DATA_DIR || path.join(ROOT, 'data');
...
function createVessel(details = {}) {
  ...
  const vessel = {
    ...
    dwt: details.dwt || '',
    notes: details.notes || '',
    mcrRpm: details.mcrRpm ?? null,
    mcrKw: details.mcrKw ?? null,
    csrRpm: details.csrRpm ?? null,
    csrKw: details.csrKw ?? null,
    pitch: details.pitch ?? null,
    sfoc100: details.sfoc100 ?? null,
    sfoc85: details.sfoc85 ?? null,
    slocRef: details.slocRef ?? null,
    mechEff: details.mechEff ?? null,
    fuelDensity: details.fuelDensity ?? null,
    lubeDensity: details.lubeDensity ?? null,
    lcvRef: details.lcvRef ?? null,
    lcvActual: details.lcvActual ?? null,
    propLawExp: details.propLawExp ?? null,
    createdAt: now(),
    updatedAt: now(),
  };
